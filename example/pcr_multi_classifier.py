...
def main():
    ...
    from simulasi_data_lemak.fatty_acid.load_spectra_data import load_config
    ...
    unique_labels = np.unique(y_pure_label) # ['chicken', 'cow', 'duck', 'goat', 'pig_b', 'pig_p', 'pig_rj', 'pig_s']
